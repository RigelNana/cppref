...
source_url: "https://en.cppreference.com/w/cpp/language/ctad"
language: "C++"
---

{/* source:cpp-language-ctad:0000 */}
...
{/* source:cpp-language-ctad:0003 */}
- [new-expressions](/docs/cpp/language/expressions/new):

{/* source:cpp-language-ctad:0004 */}
```cpp
template<class T>
struct A
{
...
<DeclarationDoc>
  ...
  <Declaration id="2" language="cpp" grammar code="template < template-parameter-list > requires-clause (optional) explicit (optional) template-name ( parameter-list ) -> simple-template-id requires-clause (optional) ;" />
</DeclarationDoc>

{/* source:cpp-language-ctad:0025 */}
<ParameterList>
  ...
  <Parameter name="requires-clause">
    <InlineRevision since="C++20" /> a [`requires` clause](/docs/cpp/language/templates/constraints#Requires_clauses)
  </Parameter>
</ParameterList>

{/* source:cpp-language-ctad:0026 */}
<Revision since="C++20">
...
{/* source:cpp-language-ctad:0038 */}
User-defined deduction guides do not have to be templates:

{/* source:cpp-language-ctad:0039 */}
```cpp
template<class T>
struct S
{
...
{/* source:cpp-language-ctad:0056 */}
The following behavior-changing defect reports were applied retroactively to previously published C++ standards.

{/* source:cpp-language-ctad:0057 */}
<DefectReportList>
  <DefectReport kind="cwg" id={2376} standard="C++17">
    <PublishedBehavior>CTAD would be performed even if the type of the variable declared is different from the class template whose arguments will be deduced</PublishedBehavior>
    <CorrectedBehavior>do not perform CTAD in this case</CorrectedBehavior>
  </DefectReport>
  <DefectReport kind="cwg" id={2628} standard="C++20">
    <PublishedBehavior>implicit deduction guides did not propagate constraints</PublishedBehavior>
    <CorrectedBehavior>propogate constraints</CorrectedBehavior>
  </DefectReport>
  <DefectReport kind="cwg" id={2697} standard="C++20">
    <PublishedBehavior>it was unclear whether the abbreviated function template syntax is allowed in user-defined deduction guides</PublishedBehavior>
    <CorrectedBehavior>prohibited</CorrectedBehavior>
  </DefectReport>
  <DefectReport kind="cwg" id={2707} standard="C++20">
    <PublishedBehavior>deduction guides could not have a trailing `requires` clause</PublishedBehavior>
    <CorrectedBehavior>they can</CorrectedBehavior>
  </DefectReport>
  <DefectReport kind="cwg" id={2714} standard="C++17">
    <PublishedBehavior>implicit deduction guides did not consider the default aguments of constructors</PublishedBehavior>
    <CorrectedBehavior>consider them</CorrectedBehavior>
  </DefectReport>
  <DefectReport kind="cwg" id={2913} standard="C++20">
    <PublishedBehavior>the resolution of [CWG issue 2707](https://cplusplus.github.io/CWG/issues/2707.html) made the deduction guide syntax inconsistent with the function declaration syntax</PublishedBehavior>
    <CorrectedBehavior>adjusted the syntax</CorrectedBehavior>
  </DefectReport>
  <DefectReport kind="paper" id="P0702R1" standard="C++17">
    <PublishedBehavior>an initializer-list constructor can pre-empt the copy deduction candidate, resulting in wrapping</PublishedBehavior>
    <CorrectedBehavior>initializer-list phase skipped when copying</CorrectedBehavior>
  </DefectReport>
</DefectReportList>
