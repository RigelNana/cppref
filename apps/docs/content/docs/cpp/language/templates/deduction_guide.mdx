...
description: "In order to instantiate a class template, every template argument must be known, but not every template argument has to be specified. In the following contexts the compiler will deduce the template arguments from the type of the initializer."
source_url: "https://en.cppreference.com/w/cpp/language/deduction_guide"
language: "C++"
---

{/* source:cpp-language-deduction-guide:0000 */}
...
{/* source:cpp-language-deduction-guide:0001 */}
...
{/* source:cpp-language-deduction-guide:0002 */}
```cpp
...
{/* source:cpp-language-deduction-guide:0003 */}
- [new-expressions](/docs/cpp/language/expressions/new):

{/* source:cpp-language-deduction-guide:0004 */}
```cpp
template<class T>
struct A
{
...
{/* source:cpp-language-deduction-guide:0005 */}
- [function-style cast](/docs/cpp/language/expressions/explicit_cast) expressions:

{/* source:cpp-language-deduction-guide:0006 */}
```cpp
...
{/* source:cpp-language-deduction-guide:0007 */}
<Revision since="C++20">
...
{/* source:cpp-language-deduction-guide:0008 */}
...
{/* source:cpp-language-deduction-guide:0009 */}
...
{/* source:cpp-language-deduction-guide:0010 */}
...
{/* source:cpp-language-deduction-guide:0011 */}
  <Revision since="C++20">
...
{/* source:cpp-language-deduction-guide:0012 */}
  - The [parameter list](/docs/cpp/language/functions/function#Parameter_list) of `Fi` is the parameter list of `Ci`. The return type of `Fi` is `C` followed by the template parameters of the class template enclosed in `<>`.

{/* source:cpp-language-deduction-guide:0013 */}
...
{/* source:cpp-language-deduction-guide:0014 */}
...
{/* source:cpp-language-deduction-guide:0015 */}
...
{/* source:cpp-language-deduction-guide:0016 */}
...
{/* source:cpp-language-deduction-guide:0017 */}
<Revision since="C++20">
- In addition, if
...
{/* source:cpp-language-deduction-guide:0018 */}
...
{/* source:cpp-language-deduction-guide:0019 */}
...
{/* source:cpp-language-deduction-guide:0020 */}
```cpp
template<class T>
struct UniquePtr
{
...
{/* source:cpp-language-deduction-guide:0021 */}
...
{/* source:cpp-language-deduction-guide:0022 */}
```cpp
template<class T>
struct S
{
...
{/* source:cpp-language-deduction-guide:0023 */}
...
{/* source:cpp-language-deduction-guide:0024 */}
<DeclarationDoc>
...
{/* source:cpp-language-deduction-guide:0025 */}
<ParameterList>
...
{/* source:cpp-language-deduction-guide:0026 */}
<Revision since="C++20">
...
{/* source:cpp-language-deduction-guide:0027 */}
...
{/* source:cpp-language-deduction-guide:0028 */}
...
{/* source:cpp-language-deduction-guide:0029 */}
```cpp
...
{/* source:cpp-language-deduction-guide:0030 */}
The fictional constructors for the purpose of overload resolution (described above) are explicit if they correspond to an implicitly-generated deduction guide formed from an [explicit](/docs/cpp/language/classes/explicit) constructor or to a user-defined deduction guide that is declared explicit. As always, such constructors are ignored in copy-initialization context:

{/* source:cpp-language-deduction-guide:0031 */}
```cpp
template<class T>
struct A
{
...
{/* source:cpp-language-deduction-guide:0032 */}
...
{/* source:cpp-language-deduction-guide:0033 */}
```cpp
template<class T>
struct B
{
...
{/* source:cpp-language-deduction-guide:0034 */}
<Revision since="C++20">
...
{/* source:cpp-language-deduction-guide:0035 */}
...
{/* source:cpp-language-deduction-guide:0036 */}
```cpp
...
{/* source:cpp-language-deduction-guide:0037 */}
<Revision until="C++20">
...
{/* source:cpp-language-deduction-guide:0038 */}
User-defined deduction guides do not have to be templates:

{/* source:cpp-language-deduction-guide:0039 */}
```cpp
template<class T>
struct S
{
...
{/* source:cpp-language-deduction-guide:0040 */}
...
{/* source:cpp-language-deduction-guide:0041 */}
```cpp
template<class T>
struct X
{
...
{/* source:cpp-language-deduction-guide:0042 */}
...
{/* source:cpp-language-deduction-guide:0043 */}
```cpp
template<class T>
struct A
{
...
{/* source:cpp-language-deduction-guide:0044 */}
...
{/* source:cpp-language-deduction-guide:0045 */}
...
{/* source:cpp-language-deduction-guide:0046 */}
```cpp
template<class T>
struct A
{
...
{/* source:cpp-language-deduction-guide:0047 */}
...
{/* source:cpp-language-deduction-guide:0048 */}
```cpp
template<class T>
struct A
{
...
{/* source:cpp-language-deduction-guide:0049 */}
...
{/* source:cpp-language-deduction-guide:0050 */}
```cpp
...
{/* source:cpp-language-deduction-guide:0051 */}
...
{/* source:cpp-language-deduction-guide:0052 */}
```cpp
std::vector v1{1, 2}; // std::vector<int>
...
{/* source:cpp-language-deduction-guide:0053 */}
...
| [`__cpp_deduction_guides`](/docs/cpp/library/feature_test#cpp_deduction_guides) | [`201907L`](/docs/cpp/library/compiler_support/20#cpp_deduction_guides_201907L) | (C++20) | CTAD for aggregates and aliases |

## Defect reports

{/* source:cpp-language-deduction-guide:0056 */}
The following behavior-changing defect reports were applied retroactively to previously published C++ standards.

{/* source:cpp-language-deduction-guide:0057 */}
<DefectReportList>
