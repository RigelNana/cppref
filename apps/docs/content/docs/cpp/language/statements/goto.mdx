...
description: "Transfers control unconditionally."
source_url: "https://en.cppreference.com/w/cpp/language/goto"
language: "C++"
---

{/* source:cpp-language-goto:0000 */}
Transfers control unconditionally.

{/* source:cpp-language-goto:0001 */}
Used when it is otherwise impossible to transfer control to the desired location using other statements.

## Syntax

{/* source:cpp-language-goto:0002 */}
<DeclarationDoc>
  <Declaration language="cpp" grammar code="attr (optional) goto label ;" />
</DeclarationDoc>

## Explanation

{/* source:cpp-language-goto:0003 */}
The `goto` statement transfers control to the location specified by [label](/docs/cpp/language/statements#Labels). The `goto` statement must be in the same function as the label it is referring, it may appear before or after the label.

{/* source:cpp-language-goto:0004 */}
...
{/* source:cpp-language-goto:0005 */}
The `goto` statement cannot transfer control into a [control-flow-limited statement](/docs/cpp/language/statements#Control-flow-limited_statements), but can transfer control out of a control-flow-limited statement (the rules above regarding automatic variables in scope are followed).

{/* source:cpp-language-goto:0006 */}
...
{/* source:cpp-language-goto:0008 */}
(Note: the same rules apply to all forms of transfer of control)

## Notes

{/* source:cpp-language-goto:0009 */}
In the C programming language, the `goto` statement has fewer restrictions and can enter the scope of any variable other than [variable-length array](/docs/c/language/declarations/array#Variable-length_arrays) or variably-modified pointer.

## Keywords

{/* source:cpp-language-goto:0010 */}
[`goto`](/docs/cpp/language/keywords/goto)

## Example

{/* source:cpp-language-goto:0011 */}
```cpp
#include <iostream>
...
{/* source:cpp-language-goto:0012 */}
<DescriptionList>
  <DescriptionItem>
    <DescriptionTerm>[`C documentation`](/docs/c/language/statements/goto)</DescriptionTerm>
    <DescriptionBody>for `goto`</DescriptionBody>
  </DescriptionItem>
</DescriptionList>

## External links

{/* source:cpp-language-goto:0013 */}
