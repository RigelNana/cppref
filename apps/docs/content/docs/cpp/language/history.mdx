...
This TS extends the C++ library to include [several extensions](/docs/cpp/library/experimental/concurrency) to [`std::future`](/docs/cpp/library/thread/future), [`latches`](/docs/cpp/library/thread/latch) and [`barriers`](/docs/cpp/library/thread/barrier), and atomic smart pointers.
