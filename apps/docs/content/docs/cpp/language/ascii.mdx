---
title: "ASCII Chart"
description: "The following chart contains all 128 ASCII decimal (dec), octal (oct), hexadecimal (hex) and character (ch) codes."
source_url: "https://en.cppreference.com/w/cpp/language/ascii"
language: "C++"
---

{/* source:cpp-language-ascii:0000 */}
The following chart contains all 128 ASCII decimal (dec), octal (oct), hexadecimal (hex) and character (ch) codes.

{/* source:cpp-language-ascii:0001 */}
...
{/* source:cpp-language-ascii:0002 */}
...
{/* source:cpp-language-ascii:0003 */}
```cpp
#include <iostream>
...
{/* source:cpp-language-ascii:0004 */}
<DescriptionList>
  <DescriptionItem>
    <DescriptionTerm>[C documentation](/docs/c/language/basic_concepts/ascii)</DescriptionTerm>
    <DescriptionBody>for ASCII Chart</DescriptionBody>
  </DescriptionItem>
</DescriptionList>