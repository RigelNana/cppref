...
description: "Allow the compiler to optimize for the case where paths of execution including that statement are more or less likely than any alternative path of execution that does not include such a statement."
source_url: "https://en.cppreference.com/w/cpp/language/attributes/likely"
language: "C++"
---

{/* source:cpp-language-attributes-likely:0000 */}
...
{/* source:cpp-language-attributes-likely:0001 */}
<DeclarationDoc>
  <Declaration id="1" language="cpp" grammar code="[[likely]]" />
  <Declaration id="2" language="cpp" grammar code="[[unlikely]]" />
</DeclarationDoc>

## Explanation

{/* source:cpp-language-attributes-likely:0002 */}
...
{/* source:cpp-language-attributes-likely:0003 */}
...
{/* source:cpp-language-attributes-likely:0004 */}
...
{/* source:cpp-language-attributes-likely:0007 */}
...
{/* source:cpp-language-attributes-likely:0008 */}
```cpp
#include <chrono>
#include <cmath>
#include <iomanip>
...
{/* source:cpp-language-attributes-likely:0009 */}
- C++23 standard (ISO/IEC 14882:2024): 9.12.7 Likelihood attributes [dcl.attr.likelihood]

{/* source:cpp-language-attributes-likely:0010 */}
- C++20 standard (ISO/IEC 14882:2020): 9.12.6 Likelihood attributes [dcl.attr.likelihood]
