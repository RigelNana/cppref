...
description: "Constants that provide a portable way to access the L1 data cache line size."
source_url: "https://en.cppreference.com/w/cpp/thread/hardware_destructive_interference_size"
language: "C++"
---

{/* source:cpp-thread-hardware-destructive-interference-size:0000 */}
<DeclarationDoc>
Defined in header [`<new>`](/docs/cpp/library/headers/new)

  <Declaration id="1" language="cpp" since="C++17" code={`inline constexpr std::size_t
    hardware_destructive_interference_size = /*implementation-defined*/;`} />
  <Declaration id="2" language="cpp" since="C++17" code={`inline constexpr std::size_t
    hardware_constructive_interference_size = /*implementation-defined*/;`} />
</DeclarationDoc>

{/* source:cpp-thread-hardware-destructive-interference-size:0001 */}
1. 1) Minimum offset between two objects to avoid false sharing. Guaranteed to be at least `alignof(std::max_align_t)`:
...
{/* source:cpp-thread-hardware-destructive-interference-size:0002 */}
2. 2) Maximum size of contiguous memory to promote true sharing. Guaranteed to be at least `alignof(std::max_align_t)`:
...
{/* source:cpp-thread-hardware-destructive-interference-size:0003 */}
These constants provide a portable way to access the L1 data cache line size.

{/* source:cpp-thread-hardware-destructive-interference-size:0004 */}
| [Feature-test](/docs/cpp/library/utility/feature_test) macro | Value | Std | Feature |
| --- | --- | --- | --- |
| [`__cpp_lib_hardware_interference_size`](/docs/cpp/library/feature_test#cpp_lib_hardware_interference_size) | [`201703L`](/docs/cpp/library/compiler_support/17#cpp_lib_hardware_interference_size_201703L) | (C++17) | `constexpr std::hardware_constructive_interference_size` and `constexpr std::hardware_destructive_interference_size` |

### Example

{/* source:cpp-thread-hardware-destructive-interference-size:0005 */}
...
{/* source:cpp-thread-hardware-destructive-interference-size:0006 */}
<DescriptionList>
  <DescriptionItem>
    <DescriptionTerm>[`hardware_concurrency`](/docs/cpp/library/thread/thread/hardware_concurrency)</DescriptionTerm>
    <DescriptionBody>returns the number of concurrent threads supported by the implementation (public static member function of `std::thread`)</DescriptionBody>
  </DescriptionItem>
  <DescriptionItem>
    <DescriptionTerm>[`hardware_concurrency`](/docs/cpp/library/thread/jthread/hardware_concurrency)</DescriptionTerm>
    <DescriptionBody>returns the number of concurrent threads supported by the implementation (public static member function of `std::jthread`)</DescriptionBody>
  </DescriptionItem>
</DescriptionList>
