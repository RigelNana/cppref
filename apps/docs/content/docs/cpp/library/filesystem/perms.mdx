...
description: "This type represents file access permissions."
source_url: "https://en.cppreference.com/w/cpp/filesystem/perms"
language: "C++"
---

{/* source:cpp-filesystem-perms:0000 */}
<DeclarationDoc>
Defined in header [`<filesystem>`](/docs/cpp/library/headers/filesystem)

  <Declaration language="cpp" since="C++17" code={`enum class perms;`} />
</DeclarationDoc>

{/* source:cpp-filesystem-perms:0001 */}
This type represents file access permissions.

{/* source:cpp-filesystem-perms:0002 */}
...
{/* source:cpp-filesystem-perms:0003 */}
Access permissions model [POSIX permission bits](https://pubs.opengroup.org/onlinepubs/9699919799/basedefs/sys_stat.h.html), and any individual file permissions (as reported by [`filesystem::status`](/docs/cpp/library/filesystem/status)) are a combination of some of the following bits:

{/* source:cpp-filesystem-perms:0004 */}
...
{/* source:cpp-filesystem-perms:0005 */}
Additionally, the following constants of this type are defined, which do not represent permissions:

{/* source:cpp-filesystem-perms:0006 */}
| Member constant | Value (hex) | Meaning |
| --- | --- | --- |
| `unknown` | `0xFFFF` | Unknown permissions (e.g. when [`filesystem::file_status`](/docs/cpp/library/filesystem/file_status) is created without permissions) |

{/* source:cpp-filesystem-perms:0007 */}
Permissions may not necessarily be implemented as bits, but they are treated that way conceptually.

{/* source:cpp-filesystem-perms:0008 */}
...
{/* source:cpp-filesystem-perms:0009 */}
```cpp
#include <filesystem>
#include <fstream>
#include <iostream>
...
{/* source:cpp-filesystem-perms:0010 */}
<DescriptionList>
  <DescriptionItem>
    <DescriptionTerm>[`status` `symlink_status`](/docs/cpp/library/filesystem/status) <InlineRevision since="C++17" /></DescriptionTerm>
