...
description: "This type represents available options that control the behavior of the copy() and copy_file() function."
source_url: "https://en.cppreference.com/w/cpp/filesystem/copy_options"
language: "C++"
---

{/* source:cpp-filesystem-copy-options:0000 */}
<DeclarationDoc>
Defined in header [`<filesystem>`](/docs/cpp/library/headers/filesystem)

  <Declaration language="cpp" since="C++17" code={`enum class copy_options {
    none = /* unspecified */,
...
{/* source:cpp-filesystem-copy-options:0001 */}
This type represents available options that control the behavior of the [`copy()`](/docs/cpp/library/filesystem/copy) and [`copy_file()`](/docs/cpp/library/filesystem/copy_file) function.

{/* source:cpp-filesystem-copy-options:0002 */}
...
{/* source:cpp-filesystem-copy-options:0003 */}
...
{/* source:cpp-filesystem-copy-options:0004 */}
| Member constant | Meaning |
| --- | --- |
| **options controlling [`copy_file()`](/docs/cpp/library/filesystem/copy_file) when the file already exists** | |
...
| **options controlling the effects of [`copy()`](/docs/cpp/library/filesystem/copy) on subdirectories** | |
| `none` | Skip subdirectories (default behavior). |
| `recursive` | Recursively copy subdirectories and their content. |
| **options controlling the effects of [`copy()`](/docs/cpp/library/filesystem/copy) on symbolic links** | |
...
| **options controlling the kind of copying [`copy()`](/docs/cpp/library/filesystem/copy) does** | |
...
{/* source:cpp-filesystem-copy-options:0005 */}
```cpp
#include <cstdlib>
#include <filesystem>
#include <fstream>
...
{/* source:cpp-filesystem-copy-options:0006 */}
<DescriptionList>
  <DescriptionItem>
