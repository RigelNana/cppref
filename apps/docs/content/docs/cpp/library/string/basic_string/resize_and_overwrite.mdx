...
description: "Resizes the string to contain at most count characters, using the user-provided operation op to modify the possibly indeterminate contents and set the length."
source_url: "https://en.cppreference.com/w/cpp/string/basic_string/resize_and_overwrite"
language: "C++"
---

{/* source:cpp-string-basic-string-resize-and-overwrite:0000 */}
<DeclarationDoc>
Defined in header [`<string>`](/docs/cpp/library/headers/string)

  <Declaration language="cpp" since="C++23" code={`template< class Operation >
constexpr void resize_and_overwrite( size_type count, Operation op );`} />
</DeclarationDoc>

{/* source:cpp-string-basic-string-resize-and-overwrite:0001 */}
Resizes the string to contain at most `count` characters, using the user-provided operation `op` to modify the possibly indeterminate contents and set the length. This avoids the cost of initializing a suitably-sized [`std::string`](/docs/cpp/library/string/basic_string) when it is intended to be used as a char array to be populated by, e.g., a C API call.

{/* source:cpp-string-basic-string-resize-and-overwrite:0002 */}
This function performs the following steps:

{/* source:cpp-string-basic-string-resize-and-overwrite:0003 */}
...
{/* source:cpp-string-basic-string-resize-and-overwrite:0004 */}
If `r` is not of an [integer-like type](/docs/cpp/library/iterator/is-integer-like), the program is ill-formed.

{/* source:cpp-string-basic-string-resize-and-overwrite:0005 */}
If any of the following conditions is satisfied, the behavior is undefined:

{/* source:cpp-string-basic-string-resize-and-overwrite:0006 */}
...
{/* source:cpp-string-basic-string-resize-and-overwrite:0007 */}
...
{/* source:cpp-string-basic-string-resize-and-overwrite:0008 */}
<ParameterList>
  <Parameter name="count">the maximal possible new size of the string</Parameter>
  <Parameter name="op">the function object used for setting the new contents of the string</Parameter>
</ParameterList>

### Exceptions

{/* source:cpp-string-basic-string-resize-and-overwrite:0009 */}
[`std::length_error`](/docs/cpp/library/error/length_error) if `count > max_size()`. Any exceptions thrown by corresponding `Allocator`.

{/* source:cpp-string-basic-string-resize-and-overwrite:0010 */}
...
{/* source:cpp-string-basic-string-resize-and-overwrite:0011 */}
...
{/* source:cpp-string-basic-string-resize-and-overwrite:0012 */}
| [Feature-test](/docs/cpp/library/utility/feature_test) macro | Value | Std | Feature |
| --- | ---: | --- | --- |
| [`__cpp_lib_string_resize_and_overwrite`](/docs/cpp/library/feature_test#cpp_lib_string_resize_and_overwrite) | [`202110L`](/docs/cpp/library/compiler_support/23#cpp_lib_string_resize_and_overwrite_202110L) | (C++23) | `std::basic_string::resize_and_overwrite` |

### Example

{/* source:cpp-string-basic-string-resize-and-overwrite:0013 */}
...
{/* source:cpp-string-basic-string-resize-and-overwrite:0014 */}
<DescriptionList>
  <DescriptionItem>
