...
source_url: "https://en.cppreference.com/w/cpp/io/strstream/freeze"
language: "C++"
---

{/* source:cpp-io-strstream-freeze:0000 */}
<DeclarationDoc>
  <Declaration language="cpp" until="C++26" code={`void freeze( bool flag = true );`} /> (deprecated in C++98)
</DeclarationDoc>

{/* source:cpp-io-strstream-freeze:0001 */}
...
{/* source:cpp-io-strstream-freeze:0004 */}

(none)

### Example

{/* source:cpp-io-strstream-freeze:0005 */}
...
{/* source:cpp-io-strstream-freeze:0006 */}
