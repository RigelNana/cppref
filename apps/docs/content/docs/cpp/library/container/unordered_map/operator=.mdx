...
source_url: "https://en.cppreference.com/w/cpp/container/unordered_map/operator="
language: "C++"
---

{/* source:cpp-container-unordered-map-operator:0000 */}
<DeclarationDoc>
  <Declaration id="1" language="cpp" since="C++11" code={`unordered_map& operator=( const unordered_map& other );`} />
  <Declaration id="2" language="cpp" until="C++17" code={`unordered_map& operator=( unordered_map&& other );`} />
  <Declaration id="2" language="cpp" since="C++17" code={`unordered_map& operator=( unordered_map&& other ) noexcept(/* see below */);`} />
  <Declaration id="3" language="cpp" since="C++11" code={`unordered_map& operator=( std::initializer_list<value_type> ilist );`} />
</DeclarationDoc>

{/* source:cpp-container-unordered-map-operator:0001 */}
Replaces the contents of the container.

{/* source:cpp-container-unordered-map-operator:0002 */}
- 1) Copy assignment operator. Replaces the contents with a copy of the contents of `other`.

{/* source:cpp-container-unordered-map-operator:0003 */}
...
{/* source:cpp-container-unordered-map-operator:0004 */}
...
{/* source:cpp-container-unordered-map-operator:0005 */}
...
{/* source:cpp-container-unordered-map-operator:0006 */}
- 3) Replaces the contents with those identified by initializer list `ilist`.

### Parameters

{/* source:cpp-container-unordered-map-operator:0007 */}
<ParameterList>
...
{/* source:cpp-container-unordered-map-operator:0008 */}
`*this`

### Complexity

{/* source:cpp-container-unordered-map-operator:0009 */}
- 1) Linear in the size of `*this` and `other`.

{/* source:cpp-container-unordered-map-operator:0010 */}
...
{/* source:cpp-container-unordered-map-operator:0011 */}
- 3) Linear in the size of `*this` and `ilist`.

### Exceptions

{/* source:cpp-container-unordered-map-operator:0012 */}
<Revision until="C++17">
...
{/* source:cpp-container-unordered-map-operator:0013 */}
...
{/* source:cpp-container-unordered-map-operator:0014 */}
The following code uses `operator=` to assign one [`std::unordered_map`](/docs/cpp/library/container/unordered_map) to another:
...
{/* source:cpp-container-unordered-map-operator:0015 */}
<DescriptionList>
  <DescriptionItem>
