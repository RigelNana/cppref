...
source_url: "https://en.cppreference.com/w/cpp/container/map/operator="
language: "C++"
---

{/* source:cpp-container-map-operator:0000 */}
<DeclarationDoc>
  <Declaration id="1" language="cpp" since="C++98" code={`map& operator=( const map& other );`} />
  <Declaration id="2" language="cpp" since="C++11" until="C++17" code={`map& operator=( map&& other );`} />
  <Declaration id="2" language="cpp" since="C++17" code={`map& operator=( map&& other ) noexcept(/* see below */);`} />
  <Declaration id="3" language="cpp" since="C++11" code={`map& operator=( std::initializer_list<value_type> ilist );`} />
</DeclarationDoc>

{/* source:cpp-container-map-operator:0001 */}
Replaces the contents of the container.

{/* source:cpp-container-map-operator:0002 */}
...
{/* source:cpp-container-map-operator:0003 */}
...
{/* source:cpp-container-map-operator:0004 */}
...
{/* source:cpp-container-map-operator:0005 */}
3. Replaces the contents with those identified by initializer list `ilist`.

## Parameters

{/* source:cpp-container-map-operator:0006 */}
<ParameterList>
...
{/* source:cpp-container-map-operator:0007 */}
`*this`

## Complexity

{/* source:cpp-container-map-operator:0008 */}
1. Linear in the size of `*this` and `other`.

{/* source:cpp-container-map-operator:0009 */}
...
{/* source:cpp-container-map-operator:0010 */}
3. `O(NlogN)` in general, where `N` is `size() + ilist.size()`. Linear if `ilist` is sorted with respect to [`value_comp()`](/docs/cpp/library/container/map/value_comp).

## Exceptions

{/* source:cpp-container-map-operator:0011 */}
<Revision until="C++17">
...
2) [`noexcept`](/docs/cpp/language/exceptions/noexcept_spec) specification: `noexcept(std::allocator_traits<Allocator>::is_always_equal::value && std::is_nothrow_move_assignable<Compare>::value)`
</Revision>

## Notes

{/* source:cpp-container-map-operator:0012 */}
...
{/* source:cpp-container-map-operator:0013 */}
The following code uses `operator=` to assign one [`std::map`](/docs/cpp/library/container/map) to another:
...
{/* source:cpp-container-map-operator:0014 */}
<DescriptionList>
  <DescriptionItem>
