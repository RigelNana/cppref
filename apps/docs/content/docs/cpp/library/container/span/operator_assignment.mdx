...
description: "Assigns other to *this."
source_url: "https://en.cppreference.com/w/cpp/container/span/operator="
language: "C++"
---

{/* source:cpp-container-span-operator:0000 */}
<DeclarationDoc>
  <Declaration language="cpp" since="C++20" code={`constexpr span& operator=( const span& other ) noexcept = default;`} />
</DeclarationDoc>

{/* source:cpp-container-span-operator:0001 */}
...
{/* source:cpp-container-span-operator:0002 */}
<ParameterList>
...
{/* source:cpp-container-span-operator:0003 */}
`*this`

## Example

{/* source:cpp-container-span-operator:0004 */}
```cpp
#include <algorithm>
#include <array>
#include <cassert>
...
{/* source:cpp-container-span-operator:0005 */}
<DescriptionList>
  <DescriptionItem>
    <DescriptionTerm>[(constructor)](/docs/cpp/library/container/span/span)</DescriptionTerm>
    <DescriptionBody>constructs the `span` (public member function)</DescriptionBody>
  </DescriptionItem>
  <DescriptionItem>
