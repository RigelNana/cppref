...
source_url: "https://en.cppreference.com/w/cpp/container/set/operator="
language: "C++"
---


{/* source:cpp-container-set-operator:0000 */}
<DeclarationDoc>
  <Declaration id="1" language="cpp" since="C++98" code={`set& operator=( const set& other );`} />
  <Declaration id="2" language="cpp" since="C++11" until="C++17" code={`set& operator=( set&& other );`} />
  <Declaration id="2" language="cpp" since="C++17" code={`set& operator=( set&& other ) noexcept(/* see below */);`} />
  <Declaration id="3" language="cpp" since="C++98" code={`set& operator=( std::initializer_list<value_type> ilist );`} />
</DeclarationDoc>

{/* source:cpp-container-set-operator:0001 */}
Replaces the contents of the container.

{/* source:cpp-container-set-operator:0002 */}
...
{/* source:cpp-container-set-operator:0003 */}
...
{/* source:cpp-container-set-operator:0004 */}
...
{/* source:cpp-container-set-operator:0005 */}
- 3) Replaces the contents with those identified by initializer list `ilist`.

### Parameters

{/* source:cpp-container-set-operator:0006 */}
<ParameterList>
...
{/* source:cpp-container-set-operator:0007 */}
`*this`

### Complexity

{/* source:cpp-container-set-operator:0008 */}
- 1) Linear in the size of `*this` and `other`.

{/* source:cpp-container-set-operator:0009 */}
...
{/* source:cpp-container-set-operator:0010 */}
- 3) O(NlogN) in general, where N is `size() + ilist.size()`. Linear if `ilist` is sorted with respect to [`value_comp()`](/docs/cpp/library/container/set/value_comp).

### Exceptions

{/* source:cpp-container-set-operator:0011 */}
<Revision until="C++17">
...
{/* source:cpp-container-set-operator:0012 */}
...
{/* source:cpp-container-set-operator:0013 */}
The following code uses `operator=` to assign one [`std::set`](/docs/cpp/library/container/set) to another:
...
{/* source:cpp-container-set-operator:0014 */}
<DescriptionList>
  <DescriptionItem>
