...
source_url: "https://en.cppreference.com/w/cpp/container/deque/operator="
language: "C++"
---

{/* source:cpp-container-deque-operator:0000 */}
<DeclarationDoc>
  <Declaration id="1" language="cpp" since="C++98" code={`deque& operator=( const deque& other );`} />
  <Declaration id="2" language="cpp" since="C++11" until="C++17" code={`deque& operator=( deque&& other );`} />
  <Declaration id="2" language="cpp" since="C++17" code={`deque& operator=( deque&& other ) noexcept(/* see below */);`} />
  <Declaration id="3" language="cpp" since="C++11" code={`deque& operator=( std::initializer_list<value_type> ilist );`} />

  <DeclarationDescription>
    {/* source:cpp-container-deque-operator:0001 */}
    Replaces the contents of the container.

    {/* source:cpp-container-deque-operator:0002 */}
    ...
    {/* source:cpp-container-deque-operator:0003 */}
    ...
    {/* source:cpp-container-deque-operator:0004 */}
    ...
    {/* source:cpp-container-deque-operator:0005 */}
...
{/* source:cpp-container-deque-operator:0006 */}
<ParameterList>
...
{/* source:cpp-container-deque-operator:0007 */}
`*this`

### Complexity

{/* source:cpp-container-deque-operator:0008 */}
1) Linear in the size of `*this` and `other`.

{/* source:cpp-container-deque-operator:0009 */}
...
{/* source:cpp-container-deque-operator:0010 */}
3) Linear in the size of `*this` and `ilist`.

### Exceptions

{/* source:cpp-container-deque-operator:0011 */}
...
{/* source:cpp-container-deque-operator:0012 */}
...
{/* source:cpp-container-deque-operator:0013 */}
The following code uses `operator=` to assign one [`std::deque`](/docs/cpp/library/container/deque) to another:
...
{/* source:cpp-container-deque-operator:0014 */}
<DescriptionList>
  <DescriptionItem>
