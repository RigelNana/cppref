...
source_url: "https://en.cppreference.com/w/cpp/container/list/operator="
language: "C++"
---

{/* source:cpp-container-list-operator:0000 */}
<DeclarationDoc>
  <Declaration id="1" language="cpp" since="C++98" code={`list& operator=( const list& other );`} />
  <Declaration id="2" language="cpp" since="C++11" until="C++17" code={`list& operator=( list&& other );`} />
  <Declaration id="2" language="cpp" since="C++17" code={`list& operator=( list&& other ) noexcept(/* see below */);`} />
  <Declaration id="3" language="cpp" since="C++11" code={`list& operator=( std::initializer_list<value_type> ilist );`} />

  <DeclarationDescription>
    {/* source:cpp-container-list-operator:0001 */}
    Replaces the contents of the container.

    {/* source:cpp-container-list-operator:0002 */}
    ...
    {/* source:cpp-container-list-operator:0003 */}
    ...
    {/* source:cpp-container-list-operator:0004 */}
    ...
    {/* source:cpp-container-list-operator:0005 */}
...
{/* source:cpp-container-list-operator:0006 */}
<ParameterList>
...
{/* source:cpp-container-list-operator:0007 */}
`*this`

### Complexity

{/* source:cpp-container-list-operator:0008 */}
1) Linear in the size of `*this` and `other`.

{/* source:cpp-container-list-operator:0009 */}
...
{/* source:cpp-container-list-operator:0010 */}
3) Linear in the size of `*this` and `ilist`.

### Exceptions

{/* source:cpp-container-list-operator:0011 */}
...
{/* source:cpp-container-list-operator:0012 */}
...
{/* source:cpp-container-list-operator:0013 */}
The following code uses `operator=` to assign one [`std::list`](/docs/cpp/library/container/list) to another:
...
{/* source:cpp-container-list-operator:0014 */}
<DescriptionList>
  <DescriptionItem>
