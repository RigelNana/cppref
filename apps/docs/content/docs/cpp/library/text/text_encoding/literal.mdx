...
description: "Constructs a new text_encoding object representing the ordinary character literal encoding. It is used to determine the character encoding applied to ordinary character or string literals (e.g. \"This is literal\")."
source_url: "https://en.cppreference.com/w/cpp/text/text_encoding/literal"
language: "C++"
---

{/* source:cpp-text-text-encoding-literal:0000 */}
<DeclarationDoc>
  <Declaration language="cpp" since="C++26" code={`static consteval text_encoding literal() noexcept;`} />
</DeclarationDoc>

{/* source:cpp-text-text-encoding-literal:0001 */}
Constructs a new `text_encoding` object representing the [ordinary character literal encoding](/docs/cpp/language/basic_concepts/charset#Code_unit_and_literal_encoding). It is used to determine the character encoding applied to ordinary character or string literals (e.g. `"This is literal"`).

{/* source:cpp-text-text-encoding-literal:0002 */}
This function is deleted unless the `CHAR_BIT` is `8`.

### Parameters

{/* source:cpp-text-text-encoding-literal:0003 */}
(none)

### Return value

{/* source:cpp-text-text-encoding-literal:0004 */}
The object holding the representation of the ordinary literal encoding.

### Notes

{/* source:cpp-text-text-encoding-literal:0005 */}
...
{/* source:cpp-text-text-encoding-literal:0006 */}
...
{/* source:cpp-text-text-encoding-literal:0007 */}
