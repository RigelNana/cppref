...
description: "Attempts to parse the input stream is into the std::chrono::weekday wd according to the format string fmt."
source_url: "https://en.cppreference.com/w/cpp/chrono/weekday/from_stream"
language: "C++"
---

{/* source:cpp-chrono-weekday-from-stream:0000 */}
<DeclarationDoc>
...
{/* source:cpp-chrono-weekday-from-stream:0003 */}
...
{/* source:cpp-chrono-weekday-from-stream:0004 */}
<ParameterList>
  <Parameter name="is">an input stream</Parameter>
  <Parameter name="fmt">a format string (see below)</Parameter>
  <Parameter name="wd">object to hold the parse result</Parameter>
...
{/* source:cpp-chrono-weekday-from-stream:0005 */}
...
{/* source:cpp-chrono-weekday-from-stream:0008 */}
...
{/* source:cpp-chrono-weekday-from-stream:0009 */}
...
{/* source:cpp-chrono-weekday-from-stream:0010 */}
The following conversion specifiers are available:

{/* source:cpp-chrono-weekday-from-stream:0011 */}
...
{/* source:cpp-chrono-weekday-from-stream:0012 */}
`is`

## See also

{/* source:cpp-chrono-weekday-from-stream:0013 */}
<DescriptionList>
  <DescriptionItem>
