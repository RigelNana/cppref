...
description: "Attempts to parse the input stream is into the std::chrono::month_day md according to the format string fmt."
source_url: "https://en.cppreference.com/w/cpp/chrono/month_day/from_stream"
language: "C++"
---

{/* source:cpp-chrono-month-day-from-stream:0000 */}
<DeclarationDoc>
...
{/* source:cpp-chrono-month-day-from-stream:0003 */}
...
{/* source:cpp-chrono-month-day-from-stream:0004 */}
<ParameterList>
  <Parameter name="is">an input stream</Parameter>
  <Parameter name="fmt">a format string (see below)</Parameter>
  <Parameter name="md">object to hold the parse result</Parameter>
...
{/* source:cpp-chrono-month-day-from-stream:0005 */}
...
{/* source:cpp-chrono-month-day-from-stream:0006 */}
Each whitespace character matches zero or more whitespace characters in the input stream.

{/* source:cpp-chrono-month-day-from-stream:0007 */}
...
{/* source:cpp-chrono-month-day-from-stream:0008 */}
...
{/* source:cpp-chrono-month-day-from-stream:0009 */}
...
{/* source:cpp-chrono-month-day-from-stream:0010 */}
The following conversion specifiers are available:

{/* source:cpp-chrono-month-day-from-stream:0011 */}
...
{/* source:cpp-chrono-month-day-from-stream:0012 */}
`is`

## See also

{/* source:cpp-chrono-month-day-from-stream:0013 */}
<DescriptionList>
  <DescriptionItem>
