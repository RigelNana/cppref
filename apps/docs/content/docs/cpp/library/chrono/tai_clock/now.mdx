...
source_url: "https://en.cppreference.com/w/cpp/chrono/tai_clock/now"
language: "C++"
---

{/* source:cpp-chrono-tai-clock-now:0000 */}
<DeclarationDoc>
  <Declaration language="cpp" since="C++20" code={`static std::chrono::time_point<std::chrono::tai_clock> now();`} />
</DeclarationDoc>

{/* source:cpp-chrono-tai-clock-now:0001 */}
...
{/* source:cpp-chrono-tai-clock-now:0002 */}
A time point representing the current time.

## Example

{/* source:cpp-chrono-tai-clock-now:0003 */}
```cpp
#include <chrono>
#include <cstddef>
#include <iomanip>
