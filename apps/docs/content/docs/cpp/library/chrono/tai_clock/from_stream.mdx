...
source_url: "https://en.cppreference.com/w/cpp/chrono/tai_clock/from_stream"
language: "C++"
---

{/* source:cpp-chrono-tai-clock-from-stream:0000 */}
<DeclarationDoc>
...
{/* source:cpp-chrono-tai-clock-from-stream:0003 */}
...
{/* source:cpp-chrono-tai-clock-from-stream:0004 */}
<ParameterList>
...
{/* source:cpp-chrono-tai-clock-from-stream:0005 */}
...
{/* source:cpp-chrono-tai-clock-from-stream:0006 */}
Each whitespace character matches zero or more whitespace characters in the input stream.

{/* source:cpp-chrono-tai-clock-from-stream:0007 */}
...
{/* source:cpp-chrono-tai-clock-from-stream:0008 */}
...
{/* source:cpp-chrono-tai-clock-from-stream:0009 */}
...
{/* source:cpp-chrono-tai-clock-from-stream:0010 */}
The following conversion specifiers are available:

{/* source:cpp-chrono-tai-clock-from-stream:0011 */}
...
| `%S` `%NS` `%OS` | Parses the second as a decimal number. The width N specifies the maximum number of characters to read. The default width is 2 if `Duration` is convertible to [`std::chrono::seconds`](/docs/cpp/library/chrono/duration), otherwise it is determined by the decimal precision of `Duration` and the field is interpreted as a long double in a fixed format, with the decimal point character determined by the locale (if encountered). Leading zeroes are permitted but not required. The modified command `%OS` interprets the locale's alternative representation. |  |
...
{/* source:cpp-chrono-tai-clock-from-stream:0012 */}
`is`

## Example

{/* source:cpp-chrono-tai-clock-from-stream:0013 */}
This section is incomplete\
Reason: no example

## See also

{/* source:cpp-chrono-tai-clock-from-stream:0014 */}
<DescriptionList>
  <DescriptionItem>
