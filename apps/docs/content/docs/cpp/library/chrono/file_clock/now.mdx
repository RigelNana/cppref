...
source_url: "https://en.cppreference.com/w/cpp/chrono/file_clock/now"
language: "C++"
---

{/* source:cpp-chrono-file-clock-now:0000 */}
<DeclarationDoc>
  <Declaration language="cpp" since="C++20" code={`static std::chrono::time_point<std::chrono::file_clock> now() noexcept;`} />
</DeclarationDoc>

{/* source:cpp-chrono-file-clock-now:0001 */}
Returns a time point representing the current point in time.

## Return value

{/* source:cpp-chrono-file-clock-now:0002 */}
A time point representing the current time.

## Example

{/* source:cpp-chrono-file-clock-now:0003 */}
```cpp
#include <chrono>
#include <cstddef>
#include <iomanip>
