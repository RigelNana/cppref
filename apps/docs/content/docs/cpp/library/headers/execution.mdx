...
description: "This header is part of the execution and algorithm libraries."
source_url: "https://en.cppreference.com/w/cpp/header/execution"
language: "C++"
---

{/* source:cpp-header-execution:0000 */}
This header is part of the [`execution`](/docs/cpp/library/experimental/execution) and [`algorithm`](/docs/cpp/library/algorithm) libraries.

{/* source:cpp-header-execution:0001 */}
## Classes
...
{/* source:cpp-header-execution:0002 */}
This section is incomplete

Reason: links to execution library subpages

{/* source:cpp-header-execution:0003 */}
### Synopsis
...
{/* source:cpp-header-execution:0004 */}
#### Helper concepts
...
{/* source:cpp-header-execution:0005 */}
#### Helper classes
...
{/* source:cpp-header-execution:0006 */}
...
{/* source:cpp-header-execution:0007 */}
#### Concept scheduler
...
{/* source:cpp-header-execution:0008 */}
#### Concept receiver
...
{/* source:cpp-header-execution:0009 */}
