---
title: "Standard library header <inplace_vector> (C++26)"
description: "This header is part of the containers library."
source_url: "https://en.cppreference.com/w/cpp/header/inplace_vector"
language: "C++"
---

{/* source:cpp-header-inplace-vector:0000 */}
This header is part of the [`containers`](/docs/cpp/library/container) library.

{/* source:cpp-header-inplace-vector:0001 */}
## Includes
...
{/* source:cpp-header-inplace-vector:0002 */}
```cpp
// mostly freestanding
#include <compare>
...
{/* source:cpp-header-inplace-vector:0003 */}
```cpp
namespace std {
  template<class T, size_t N>
