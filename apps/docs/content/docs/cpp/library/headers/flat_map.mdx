...
source_url: "https://en.cppreference.com/w/cpp/header/flat_map"
language: "C++"
---

{/* source:cpp-header-flat-map:0000 */}
This header is part of the [`containers`](/docs/cpp/library/container) library.

{/* source:cpp-header-flat-map:0001 */}
## Includes
...
{/* source:cpp-header-flat-map:0002 */}
```cpp
#include <compare>
...
{/* source:cpp-header-flat-map:0003 */}
```cpp
namespace std {
  template<class Key,
           class T,
...
{/* source:cpp-header-flat-map:0004 */}
```cpp
namespace std {
  template<class Key,
           class T,
...
{/* source:cpp-header-flat-map:0005 */}
