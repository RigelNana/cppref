...
description: "A view that represents synchronous coroutine generator"
source_url: "https://en.cppreference.com/w/cpp/header/generator"
language: "C++"
---

{/* source:cpp-header-generator:0000 */}
## Classes
...
{/* source:cpp-header-generator:0001 */}
```cpp
namespace std {
...
{/* source:cpp-header-generator:0002 */}
```cpp
namespace std {
  template<class Ref, class V = void, class Allocator = void>
...
{/* source:cpp-header-generator:0003 */}
```cpp
namespace std {
...
{/* source:cpp-header-generator:0004 */}
```cpp
namespace std {
  template<class Ref, class V, class Allocator>
...
{/* source:cpp-header-generator:0005 */}
