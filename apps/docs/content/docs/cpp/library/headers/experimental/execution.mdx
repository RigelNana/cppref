---
title: "Experimental library header <experimental/execution>"
description: "This header is part of execution library, based on P2300R7."
source_url: "https://en.cppreference.com/w/cpp/header/experimental/execution"
language: "C++"
---

{/* source:cpp-header-experimental-execution:0000 */}
This header is part of [`execution`](/docs/cpp/library/experimental/execution) library, based on [P2300R7](https://wg21.link/p2300R7).

{/* source:cpp-header-experimental-execution:0001 */}
## Includes

{/* source:cpp-header-experimental-execution:0002 */}
This section is incomplete

{/* source:cpp-header-experimental-execution:0003 */}
### Synopsis
