...
description: "The header defines class templates, tag types, trait types, and function templates for element-wise operations on data-parallel objects."
source_url: "https://en.cppreference.com/w/cpp/header/experimental/simd"
language: "C++"
---

{/* source:cpp-header-experimental-simd:0000 */}
...
{/* source:cpp-header-experimental-simd:0001 */}
```cpp
