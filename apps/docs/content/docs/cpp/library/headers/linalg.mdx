---
title: "Standard library header <linalg> (C++26)"
description: "This header is part of the numeric library."
source_url: "https://en.cppreference.com/w/cpp/header/linalg"
language: "C++"
---

{/* source:cpp-header-linalg:0000 */}
This header is part of the [`numeric`](/docs/cpp/library/numeric) library.

{/* source:cpp-header-linalg:0001 */}
## Classes
