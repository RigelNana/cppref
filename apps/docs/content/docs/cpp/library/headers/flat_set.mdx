...
source_url: "https://en.cppreference.com/w/cpp/header/flat_set"
language: "C++"
---

{/* source:cpp-header-flat-set:0000 */}
This header is part of the [`containers`](/docs/cpp/library/container) library.

{/* source:cpp-header-flat-set:0001 */}
## Includes
...
{/* source:cpp-header-flat-set:0002 */}
```cpp
#include <compare>
...
{/* source:cpp-header-flat-set:0003 */}
```cpp
namespace std {
  template<class Key, class Compare = less<Key>, class KeyContainer = vector<Key>>
  class flat_set
...
{/* source:cpp-header-flat-set:0004 */}
```cpp
namespace std {
  template<class Key, class Compare = less<Key>, class KeyContainer = vector<Key>>
  class flat_multiset
...
{/* source:cpp-header-flat-set:0005 */}
