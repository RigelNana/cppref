---
title: "Standard library header <simd> (C++26)"
description: "This header is part of the numeric library."
source_url: "https://en.cppreference.com/w/cpp/header/simd"
language: "C++"
---

{/* source:cpp-header-simd:0000 */}
This header is part of the [`numeric`](/docs/cpp/library/numeric) library.

{/* source:cpp-header-simd:0001 */}
## Classes
