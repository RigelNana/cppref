...
source_url: "https://en.cppreference.com/w/cpp/header/mdspan"
language: "C++"
---

{/* source:cpp-header-mdspan:0000 */}
This header is part of the [`containers`](/docs/cpp/library/container) library.

{/* source:cpp-header-mdspan:0001 */}
## Classes
<DescriptionList>
  <DescriptionItem>
