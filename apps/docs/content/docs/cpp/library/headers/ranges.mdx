...
source_url: "https://en.cppreference.com/w/cpp/header/ranges"
language: "C++"
---

{/* source:cpp-header-ranges:0000 */}
This header is part of the [`ranges`](/docs/cpp/library/ranges) library.

## Namespace aliases

{/* source:cpp-header-ranges:0001 */}
<DeclarationDoc>
  <Declaration language="cpp" code={`namespace std {
    namespace views = ranges::views;

}`} />
</DeclarationDoc>

{/* source:cpp-header-ranges:0002 */}
The namespace alias `std::views` is provided as a shorthand for `std::ranges::views`.

{/* source:cpp-header-ranges:0003 */}
## Includes
...
<DescriptionList>
  ...
  <DescriptionItem>
    ...
    <DescriptionBody>specifies a range whose iterator type satisfies [`output_iterator`](/docs/cpp/library/iterator/output_iterator) (concept)</DescriptionBody>
  </DescriptionItem>
  <DescriptionItem>
  ...
  <DescriptionItem>
    ...
    <DescriptionBody>specifies a range whose iterator type satisfies [`bidirectional_iterator`](/docs/cpp/library/iterator/bidirectional_iterator) (concept)</DescriptionBody>
  </DescriptionItem>
  <DescriptionItem>
  ...
  <DescriptionItem>
    ...
    <DescriptionBody>specifies the requirements for a [`range`](/docs/cpp/library/ranges/range) to be safely convertible to a [`view`](/docs/cpp/library/ranges/view) (concept)</DescriptionBody>
  </DescriptionItem>
  <DescriptionItem>
    <DescriptionTerm>[`ranges::constant_range`](/docs/cpp/library/ranges/constant_range) <InlineRevision since="C++23" /></DescriptionTerm>
    <DescriptionBody>specifies that a range has read-only elements (concept)</DescriptionBody>
  </DescriptionItem>
</DescriptionList>
...
<DescriptionList>
  <DescriptionItem>
    ...
    <DescriptionBody>tags a range to be treated as a sequence rather than a single value (class template)</DescriptionBody>
  </DescriptionItem>
</DescriptionList>
...
<DescriptionList>
  ...
  <DescriptionItem>
    ...
    <DescriptionBody>a [`view`](/docs/cpp/library/ranges/view) consisting of the elements obtained by successive application of `operator>>` on the associated input stream (class template) (customization point object)</DescriptionBody>
  </DescriptionItem>
</DescriptionList>
...
<DescriptionList>
  ...
  <DescriptionItem>
    ...
    <DescriptionBody>a [`view`](/docs/cpp/library/ranges/view) consisting of the sequence obtained from flattening a [`view`](/docs/cpp/library/ranges/view) of [range, s](/docs/cpp/library/ranges/range) (class template) (range adaptor object)</DescriptionBody>
  </DescriptionItem>
  <DescriptionItem>
  ...
  <DescriptionItem>
    ...
    <DescriptionBody>a [`view`](/docs/cpp/library/ranges/view) that maps each element of adapted sequence to a tuple of both the element's position and its value (class template) (range adaptor object)</DescriptionBody>
  </DescriptionItem>
  <DescriptionItem>
  ...
  <DescriptionItem>
    ...
    <DescriptionBody>a range of [view, s](/docs/cpp/library/ranges/view) that are `N`-sized non-overlapping successive chunks of the elements of another [`view`](/docs/cpp/library/ranges/view) (class template) (range adaptor object)</DescriptionBody>
  </DescriptionItem>
  <DescriptionItem>
...
<DescriptionList>
  <DescriptionItem>
    ...
    <DescriptionBody>specifies whether a [`std::ranges::subrange`](/docs/cpp/library/ranges/subrange) models [`std::ranges::sized_range`](/docs/cpp/library/ranges/sized_range) (enum)</DescriptionBody>
  </DescriptionItem>
</DescriptionList>
...
{/* source:cpp-header-ranges:0099 */}
The following behavior-changing defect reports were applied retroactively to previously published C++ standards.

{/* source:cpp-header-ranges:0100 */}
<DefectReportList>
  <DefectReport kind="lwg" id={3914} standard="C++23">
    <PublishedBehavior>the constraint of std::ranges::enumerate_view was incorrectly specified in the synopsis</PublishedBehavior>
