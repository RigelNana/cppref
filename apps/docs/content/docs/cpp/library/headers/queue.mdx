...
source_url: "https://en.cppreference.com/w/cpp/header/queue"
language: "C++"
---

{/* source:cpp-header-queue:0000 */}
This header is part of the [`containers`](/docs/cpp/library/container) library.

{/* source:cpp-header-queue:0001 */}
## Includes
