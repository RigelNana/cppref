...
description: "Provides compile-time indexed access to the types of the elements of the tuple."
source_url: "https://en.cppreference.com/w/cpp/utility/tuple/tuple_element"
language: "C++"
---

{/* source:cpp-utility-tuple-tuple-element:0000 */}
<DeclarationDoc>
Defined in header [`<tuple>`](/docs/cpp/library/headers/tuple)

  <Declaration language="cpp" since="C++11" code={`template< std::size_t I, class... Types >
struct tuple_element< I, std::tuple<Types...> >;`} />
</DeclarationDoc>

{/* source:cpp-utility-tuple-tuple-element:0001 */}
Provides compile-time indexed access to the types of the elements of the tuple.

### Member types

{/* source:cpp-utility-tuple-tuple-element:0002 */}
<DescriptionList>
  <DescriptionItem>
    <DescriptionTerm>`type`</DescriptionTerm>
    <DescriptionBody>the type of `I` th element of the tuple, where `I` is in [`0`, `sizeof...(Types)`)</DescriptionBody>
  </DescriptionItem>
</DescriptionList>

### Possible implementation

{/* source:cpp-utility-tuple-tuple-element:0003 */}
```cpp
...
{/* source:cpp-utility-tuple-tuple-element:0004 */}
```cpp
...
{/* source:cpp-utility-tuple-tuple-element:0005 */}
<DescriptionList>
  <DescriptionItem>
