---
title: "std::any::type"
description: "Queries the contained type."
source_url: "https://en.cppreference.com/w/cpp/utility/any/type"
language: "C++"
---

{/* source:cpp-utility-any-type:0000 */}
<DeclarationDoc>
  <Declaration language="cpp" since="C++17" code={`const std::type_info& type() const noexcept;`} />
</DeclarationDoc>

{/* source:cpp-utility-any-type:0001 */}
Queries the contained type.

### Return value

{/* source:cpp-utility-any-type:0002 */}
The `typeid` of the contained value if instance is non-empty, otherwise `typeid(void)`.

### Example

{/* source:cpp-utility-any-type:0003 */}
...
{/* source:cpp-utility-any-type:0004 */}
<DescriptionList>
  <DescriptionItem>
